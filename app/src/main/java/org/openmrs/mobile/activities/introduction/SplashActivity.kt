...
class SplashActivity : ACBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            organizationDescription.typeface = typeface
            organizationDescription.setText(R.string.organization_description)
        }
        ...
        binding.openmrsLogo.startAnimation(set)
        mRunnable = Runnable {
    ...
    companion object Constants {
        const val COUNTING_DATA = "counter_file"
    }
}