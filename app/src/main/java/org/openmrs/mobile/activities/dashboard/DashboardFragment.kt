...
class DashboardFragment : BaseFragment(), View.OnClickListener {
                ...
                .setShowcaseEventListener(object : OnShowcaseEventListener {
                    override fun onShowcaseViewHide(showcaseView: ShowcaseView) {
                        when (currentViewCount) {
                            ...
                            ApplicationConstants.ShowCaseViewConstants.SHOW_REGISTER_PATIENT -> showOverlayTutorial((binding.learnMoreView).id, getString(R.string.dashboard_forms_icon_label),
    ...
    private fun setListeners() {
        with(binding) {
            ...
            learnMoreView.setOnClickListener(this@DashboardFragment)
        }
    }
    ...
    fun bindDrawableResources() {
        with(binding) {
            bindDrawableResource(findPatientButton, R.drawable.documents)
            bindDrawableResource(registryPatientButton, R.drawable.ic_patient)
            bindDrawableResource(activeVisitsButton, R.drawable.ic_assessment)
            bindDrawableResource(learnMoreButton, R.drawable.ic_learn)
    ...
    override fun onClick(v: View) {
        ...
        when (v.id) {
            ...
            R.id.learnMoreView -> findNavController().navigate(directionToFormEntry)
    ...
    private fun changeColorOfDashboardIcons() {
        with(binding) {
            ...
            ImageUtils.changeImageViewTint(context, learnMoreButton, greenColorResId)
