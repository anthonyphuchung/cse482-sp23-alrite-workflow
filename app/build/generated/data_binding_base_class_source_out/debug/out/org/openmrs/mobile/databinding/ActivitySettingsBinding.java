...
public final class ActivitySettingsBinding implements ViewBinding {
  ...
  private ActivitySettingsBinding(@NonNull LinearLayout rootView,
      @NonNull FrameLayout settingsContentFrame) {
  ...
  public static ActivitySettingsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.settingsContentFrame;
      FrameLayout settingsContentFrame = rootView.findViewById(id);
      if (settingsContentFrame == null) {
        break missingId;
      }

      return new ActivitySettingsBinding((LinearLayout) rootView, settingsContentFrame);
    }
