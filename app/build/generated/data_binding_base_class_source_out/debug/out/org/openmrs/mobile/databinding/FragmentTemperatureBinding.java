...
public final class FragmentTemperatureBinding implements ViewBinding {
  ...
  private FragmentTemperatureBinding(@NonNull LinearLayout rootView, @NonNull Button back,
  ...
  public static FragmentTemperatureBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTemperatureBinding((LinearLayout) rootView, back, buttons, days, next,
          skip);
    }
