...
public final class ActivityLearnBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView learn;

  private ActivityLearnBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView learn) {
  ...
  public static ActivityLearnBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.learn;
      RecyclerView learn = rootView.findViewById(id);
      if (learn == null) {
        break missingId;
      }

      return new ActivityLearnBinding((LinearLayout) rootView, learn);
    }
