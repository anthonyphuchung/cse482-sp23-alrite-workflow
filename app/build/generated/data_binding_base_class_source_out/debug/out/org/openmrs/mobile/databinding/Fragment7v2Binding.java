...
public final class Fragment7v2Binding implements ViewBinding {
  @NonNull
  ...
  private Fragment7v2Binding(@NonNull LinearLayout rootView, @NonNull LinearLayout Circle,
  ...
  @NonNull
  public static Fragment7v2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Fragment7v2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_7v2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Fragment7v2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Fragment7v2Binding((LinearLayout) rootView, Circle, TapOnInhale, Warning, back,
          buttons, card, elapsedTime, manual, next, reset);
    }
