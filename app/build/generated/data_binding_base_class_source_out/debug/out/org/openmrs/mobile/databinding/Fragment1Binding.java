...
public final class Fragment1Binding implements ViewBinding {
  ...
  private Fragment1Binding(@NonNull LinearLayout rootView, @NonNull Button back,
  ...
  public static Fragment1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Fragment1Binding((LinearLayout) rootView, back, buttons, next, no, radioGroup,
          yes);
    }
