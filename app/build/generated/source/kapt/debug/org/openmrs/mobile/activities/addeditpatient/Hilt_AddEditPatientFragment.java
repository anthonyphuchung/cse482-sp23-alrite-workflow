...
public abstract class Hilt_AddEditPatientFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditPatientFragment_GeneratedInjector) this.generatedComponent()).injectAddEditPatientFragment(UnsafeCasts.<AddEditPatientFragment>unsafeCast(this));
    }
  }
