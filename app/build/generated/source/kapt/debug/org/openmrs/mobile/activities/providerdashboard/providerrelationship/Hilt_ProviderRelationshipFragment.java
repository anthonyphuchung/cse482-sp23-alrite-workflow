...
public abstract class Hilt_ProviderRelationshipFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProviderRelationshipFragment_GeneratedInjector) this.generatedComponent()).injectProviderRelationshipFragment(UnsafeCasts.<ProviderRelationshipFragment>unsafeCast(this));
    }
  }
