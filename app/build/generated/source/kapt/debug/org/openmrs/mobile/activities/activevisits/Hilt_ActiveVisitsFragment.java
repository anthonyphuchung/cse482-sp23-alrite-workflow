...
public abstract class Hilt_ActiveVisitsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ActiveVisitsFragment_GeneratedInjector) this.generatedComponent()).injectActiveVisitsFragment(UnsafeCasts.<ActiveVisitsFragment>unsafeCast(this));
    }
  }
