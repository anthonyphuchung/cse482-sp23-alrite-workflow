...
public abstract class Hilt_PatientRelationshipFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PatientRelationshipFragment_GeneratedInjector) this.generatedComponent()).injectPatientRelationshipFragment(UnsafeCasts.<PatientRelationshipFragment>unsafeCast(this));
    }
  }
