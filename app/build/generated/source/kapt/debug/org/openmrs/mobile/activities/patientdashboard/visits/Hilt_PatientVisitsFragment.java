...
public abstract class Hilt_PatientVisitsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PatientVisitsFragment_GeneratedInjector) this.generatedComponent()).injectPatientVisitsFragment(UnsafeCasts.<PatientVisitsFragment>unsafeCast(this));
    }
  }
