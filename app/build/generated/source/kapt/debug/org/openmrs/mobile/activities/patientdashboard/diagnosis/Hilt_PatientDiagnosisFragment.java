...
public abstract class Hilt_PatientDiagnosisFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PatientDiagnosisFragment_GeneratedInjector) this.generatedComponent()).injectPatientDiagnosisFragment(UnsafeCasts.<PatientDiagnosisFragment>unsafeCast(this));
    }
  }
