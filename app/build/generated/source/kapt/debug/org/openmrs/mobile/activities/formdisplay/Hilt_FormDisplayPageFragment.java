...
public abstract class Hilt_FormDisplayPageFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FormDisplayPageFragment_GeneratedInjector) this.generatedComponent()).injectFormDisplayPageFragment(UnsafeCasts.<FormDisplayPageFragment>unsafeCast(this));
    }
  }
