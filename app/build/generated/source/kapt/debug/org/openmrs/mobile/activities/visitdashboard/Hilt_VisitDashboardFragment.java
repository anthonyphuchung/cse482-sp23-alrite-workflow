...
public abstract class Hilt_VisitDashboardFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VisitDashboardFragment_GeneratedInjector) this.generatedComponent()).injectVisitDashboardFragment(UnsafeCasts.<VisitDashboardFragment>unsafeCast(this));
    }
  }
