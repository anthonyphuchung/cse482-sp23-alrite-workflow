...
public abstract class Hilt_MatchingPatientsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MatchingPatientsFragment_GeneratedInjector) this.generatedComponent()).injectMatchingPatientsFragment(UnsafeCasts.<MatchingPatientsFragment>unsafeCast(this));
    }
  }
