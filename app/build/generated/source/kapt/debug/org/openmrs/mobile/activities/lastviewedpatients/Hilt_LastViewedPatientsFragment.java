...
public abstract class Hilt_LastViewedPatientsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LastViewedPatientsFragment_GeneratedInjector) this.generatedComponent()).injectLastViewedPatientsFragment(UnsafeCasts.<LastViewedPatientsFragment>unsafeCast(this));
    }
  }
