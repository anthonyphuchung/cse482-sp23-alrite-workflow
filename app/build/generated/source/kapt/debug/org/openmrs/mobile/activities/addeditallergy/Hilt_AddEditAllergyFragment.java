...
public abstract class Hilt_AddEditAllergyFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditAllergyFragment_GeneratedInjector) this.generatedComponent()).injectAddEditAllergyFragment(UnsafeCasts.<AddEditAllergyFragment>unsafeCast(this));
    }
  }
