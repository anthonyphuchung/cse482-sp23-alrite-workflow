...
public abstract class Hilt_AddEditProviderFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditProviderFragment_GeneratedInjector) this.generatedComponent()).injectAddEditProviderFragment(UnsafeCasts.<AddEditProviderFragment>unsafeCast(this));
    }
  }
