...
public abstract class Hilt_SyncedPatientsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SyncedPatientsFragment_GeneratedInjector) this.generatedComponent()).injectSyncedPatientsFragment(UnsafeCasts.<SyncedPatientsFragment>unsafeCast(this));
    }
  }
