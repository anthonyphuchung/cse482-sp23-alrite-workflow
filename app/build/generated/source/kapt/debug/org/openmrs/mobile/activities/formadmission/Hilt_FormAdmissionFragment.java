...
public abstract class Hilt_FormAdmissionFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FormAdmissionFragment_GeneratedInjector) this.generatedComponent()).injectFormAdmissionFragment(UnsafeCasts.<FormAdmissionFragment>unsafeCast(this));
    }
  }
