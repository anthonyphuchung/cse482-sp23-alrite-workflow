...
public abstract class Hilt_PatientDetailsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PatientDetailsFragment_GeneratedInjector) this.generatedComponent()).injectPatientDetailsFragment(UnsafeCasts.<PatientDetailsFragment>unsafeCast(this));
    }
  }
