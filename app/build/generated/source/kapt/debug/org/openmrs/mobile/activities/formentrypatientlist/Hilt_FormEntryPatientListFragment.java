...
public abstract class Hilt_FormEntryPatientListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FormEntryPatientListFragment_GeneratedInjector) this.generatedComponent()).injectFormEntryPatientListFragment(UnsafeCasts.<FormEntryPatientListFragment>unsafeCast(this));
    }
  }
