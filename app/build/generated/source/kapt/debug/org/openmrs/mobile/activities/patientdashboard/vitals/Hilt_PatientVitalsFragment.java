...
public abstract class Hilt_PatientVitalsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PatientVitalsFragment_GeneratedInjector) this.generatedComponent()).injectPatientVitalsFragment(UnsafeCasts.<PatientVitalsFragment>unsafeCast(this));
    }
  }
