...
public abstract class Hilt_PatientAllergyFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PatientAllergyFragment_GeneratedInjector) this.generatedComponent()).injectPatientAllergyFragment(UnsafeCasts.<PatientAllergyFragment>unsafeCast(this));
    }
  }
