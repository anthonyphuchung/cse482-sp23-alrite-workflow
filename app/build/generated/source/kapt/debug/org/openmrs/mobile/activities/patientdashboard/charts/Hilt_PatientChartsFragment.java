...
public abstract class Hilt_PatientChartsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PatientChartsFragment_GeneratedInjector) this.generatedComponent()).injectPatientChartsFragment(UnsafeCasts.<PatientChartsFragment>unsafeCast(this));
    }
  }
