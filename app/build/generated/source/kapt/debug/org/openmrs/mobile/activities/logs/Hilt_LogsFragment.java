...
public abstract class Hilt_LogsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LogsFragment_GeneratedInjector) this.generatedComponent()).injectLogsFragment(UnsafeCasts.<LogsFragment>unsafeCast(this));
    }
  }
