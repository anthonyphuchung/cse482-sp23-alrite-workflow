...
public abstract class Hilt_FormListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FormListFragment_GeneratedInjector) this.generatedComponent()).injectFormListFragment(UnsafeCasts.<FormListFragment>unsafeCast(this));
    }
  }
