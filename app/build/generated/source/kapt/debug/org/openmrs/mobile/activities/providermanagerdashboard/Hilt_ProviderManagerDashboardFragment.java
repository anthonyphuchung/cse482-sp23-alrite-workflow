...
public abstract class Hilt_ProviderManagerDashboardFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProviderManagerDashboardFragment_GeneratedInjector) this.generatedComponent()).injectProviderManagerDashboardFragment(UnsafeCasts.<ProviderManagerDashboardFragment>unsafeCast(this));
    }
  }
